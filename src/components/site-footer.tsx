      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-5 py-16">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col gap-3 text-sm">
              <a href="https://www.instagram.com/aur.iabr?igsh" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">Instagram</a>
